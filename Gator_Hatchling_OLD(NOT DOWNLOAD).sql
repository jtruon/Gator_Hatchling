-- ----------------------------------------------------------------------------------
-- #@name Joey Truong
-- #@user JFrog	--#@date 8 March 2018
-- #@project Gator_Hatchling
-- ----------------------------------------------------------------------------------

-- MySQL Script generated by MySQL Workbench
-- Tue Mar 27 18:18:04 2018
...
-- -----------------------------------------------------
-- Table `Gator_HatchlingDB`.`Student Profile`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Gator_HatchlingDB`.`Student Profile` (
  `Profile_id` INT NOT NULL,
  `Profile_name` VARCHAR(45) NULL,
  `Profilet_enrollment` VARCHAR(45) NULL,
  `Profile_GPA` DOUBLE NULL,
